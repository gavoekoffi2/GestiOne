...
export const COUNTRIES: Country[] = [
  { code: 'CI', name: "Cote d'Ivoire", currency: 'XOF', dialCode: '+225' },
  ...
  { code: 'CF', name: 'Republique centrafricaine', currency: 'XAF', dialCode: '+236' },
  { code: 'GQ', name: 'Guinee equatoriale', currency: 'XAF', dialCode: '+240' },
  { code: 'GH', name: 'Ghana', currency: 'GHS', dialCode: '+233' },
  { code: 'NG', name: 'Nigeria', currency: 'NGN', dialCode: '+234' },
  { code: 'GN', name: 'Guinee', currency: 'GNF', dialCode: '+224' },
  { code: 'CD', name: 'Republique democratique du Congo', currency: 'CDF', dialCode: '+243' },
