...
export const metadata: Metadata = { title: 'Creer mon entreprise' };
...
export default async function RegisterPage() {
  ...
  return (
    <div className="rounded-xl bg-white p-6 shadow-sm ring-1 ring-ink-200 sm:p-8">
      <h1 className="text-xl font-semibold text-ink-900">Creer mon entreprise</h1>
      <p className="mt-1 text-sm text-ink-500">
        Quelques informations suffisent. Tout est modifiable ensuite dans les parametres.
      </p>
      <div className="mt-6">
        <RegisterForm
